		...
		<div align="center">
			...
			<c:if test="${userInfo.frozen == 'yes'}">
				...
				<a class="btn btn-success"
					href="/InternetBanking/un-freeze-employee/${userInfo.user_id}/unfreeze"
			...
			<div class="mt-3">
				...
				<c:if test="${accountStatus == 'activated' }">
					<p class="text-success">
						Account has been <span class="text-decoration-underline">Activated</span>
					</p>
				</c:if>
